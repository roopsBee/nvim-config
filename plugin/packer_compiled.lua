...
_G.packer_plugins = {
  ...
  ["lsp-inlayhints.nvim"] = {
    loaded = true,
    path = "/Users/roopeshpatel/.local/share/nvim/site/pack/packer/start/lsp-inlayhints.nvim",
  ...
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/Users/roopeshpatel/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
